...
window.PESQUISAS = [
  ...
  { id: 'datafolha-sp-gov-2026-09-24', uf: 'sp', creditoFotos: 'fotos: Wikimedia Commons e TSE (licenças Creative Commons)', instituto: 'DATAFOLHA', divulgacao: '24 DE SETEMBRO',
    ...
    itens: [
      ...
      { nome: 'POLICIAL EDJANE', partido: 'AGIR', pct: 2, foto: 'tse-sp-policial-edjane' },
      { nome: 'CARLOS MACHADO', partido: 'PCB', pct: 2, foto: 'tse-sp-carlos-machado' },
      { nome: 'VERA LÚCIA', partido: 'PSTU', pct: 2, foto: 'vera-lucia' },
      { nome: 'VIVIAN MENDES', partido: 'UP', pct: 2, foto: 'tse-sp-vivian-mendes' },
      { nome: 'IZADORA DIAS', partido: 'PCO', pct: 1, foto: 'tse-sp-izadora-dias' },
      _IND(3), _BN(8),
    ] },
  { id: 'quaest-sp-gov-2026-09-23', uf: 'sp', creditoFotos: 'fotos: Wikimedia Commons e TSE (licenças Creative Commons)', instituto: 'QUAEST', divulgacao: '23 DE SETEMBRO',
    ...
    itens: [
      ...
      { nome: 'POLICIAL EDJANE', partido: 'AGIR', pct: 1, foto: 'tse-sp-policial-edjane' },
      { nome: 'VERA LÚCIA', partido: 'PSTU', pct: 1, foto: 'vera-lucia' },
      { nome: 'CARLOS MACHADO', partido: 'PCB', pct: 1, foto: 'tse-sp-carlos-machado' },
      { nome: 'IZADORA DIAS', partido: 'PCO', pct: 1, foto: 'tse-sp-izadora-dias' },
      { nome: 'VIVIAN MENDES', partido: 'UP', pct: 0, foto: 'tse-sp-vivian-mendes' },
      _IND(11), _BN(14),
    ] },
  ...
  { id: 'datafolha-rj-gov-2026-09-24', uf: 'rj', creditoFotos: 'fotos: Wikimedia Commons e TSE (licenças Creative Commons)', instituto: 'DATAFOLHA', divulgacao: '24 DE SETEMBRO',
    ...
    itens: [
      ...
      { nome: 'WILLIAM SIRI', partido: 'PSOL', pct: 2, foto: 'tse-rj-william-siri' },
      { nome: 'ANDRÉ MARINHO', partido: 'NOVO', pct: 2, foto: 'tse-rj-andre-marinho' },
      { nome: 'CYRO GARCIA', partido: 'PSTU', pct: 2, foto: 'cyro-garcia' },
      { nome: 'CORONEL BUSNELLO', partido: 'MISSÃO', pct: 2, foto: 'tse-rj-coronel-busnello' },
      { nome: 'JULIETE PANTOJA', partido: 'UP', pct: 1, foto: 'tse-rj-juliete' },
      { nome: 'LUAN MONTEIRO', partido: 'PCO', pct: 0, foto: 'tse-rj-luan-monteiro' },
      _IND(4), _BN(6),
    ] },
  { id: 'quaest-rj-gov-2026-09-23', uf: 'rj', creditoFotos: 'fotos: Wikimedia Commons e TSE (licenças Creative Commons)', instituto: 'QUAEST', divulgacao: '23 DE SETEMBRO',
    ...
    itens: [
      ...
      { nome: 'WILLIAM SIRI', partido: 'PSOL', pct: 1, foto: 'tse-rj-william-siri' },
      { nome: 'CORONEL BUSNELLO', partido: 'MISSÃO', pct: 1, foto: 'tse-rj-coronel-busnello' },
      { nome: 'ANDRÉ MARINHO', partido: 'NOVO', pct: 1, foto: 'tse-rj-andre-marinho' },
      { nome: 'JULIETE PANTOJA', partido: 'UP', pct: 1, foto: 'tse-rj-juliete' },
      { nome: 'LUAN MONTEIRO', partido: 'PCO', pct: 0, foto: 'tse-rj-luan-monteiro' },
      _IND(16), _BN(12),
    ] },
  ...
  { id: 'datafolha-mg-gov-2026-09-24', uf: 'mg', creditoFotos: 'fotos: Wikimedia Commons e TSE (licenças Creative Commons)', instituto: 'DATAFOLHA', divulgacao: '24 DE SETEMBRO',
    ...
    itens: [
      ...
      { nome: 'FLÁVIO ROSCOE', partido: 'PL', pct: 5, foto: 'tse-mg-flavio-roscoe' },
      { nome: 'GABRIEL', partido: 'MDB', pct: 3, foto: 'tse-mg-gabriel' },
      { nome: 'PROFESSOR TÚLIO LOPES', partido: 'PCB', pct: 2, foto: 'tse-mg-professor-tulio-lopes' },
      { nome: 'RAFAEL DUDA', partido: 'PSTU', pct: 1, foto: 'tse-mg-rafael-duda' },
      { nome: 'BEN MENDES', partido: 'MISSÃO', pct: 1, foto: 'tse-mg-ben-mendes' },
      { nome: 'HENRIQUE ÁREAS', partido: 'PCO', pct: 1, foto: 'tse-mg-henrique-areas' },
      { nome: 'INDIRA XAVIER', partido: 'UP', pct: 1, foto: 'tse-mg-indira-xavier' },
      _IND(10), _BN(9),
    ] },
  { id: 'quaest-mg-gov-2026-09-23', uf: 'mg', creditoFotos: 'fotos: Wikimedia Commons e TSE (licenças Creative Commons)', instituto: 'QUAEST', divulgacao: '23 DE SETEMBRO',
    ...
    itens: [
      ...
      { nome: 'FLÁVIO ROSCOE', partido: 'PL', pct: 5, foto: 'tse-mg-flavio-roscoe' },
      { nome: 'GABRIEL', partido: 'MDB', pct: 2, foto: 'tse-mg-gabriel' },
      { nome: 'BEN MENDES', partido: 'MISSÃO', pct: 1, foto: 'tse-mg-ben-mendes' },
      { nome: 'PROFESSOR TÚLIO LOPES', partido: 'PCB', pct: 1, foto: 'tse-mg-professor-tulio-lopes' },
      { nome: 'INDIRA XAVIER', partido: 'UP', pct: 0, foto: 'tse-mg-indira-xavier' },
      { nome: 'HENRIQUE ÁREAS', partido: 'PCO', pct: 0, foto: 'tse-mg-henrique-areas' },
      { nome: 'RAFAEL DUDA', partido: 'PSTU', pct: 0, foto: 'tse-mg-rafael-duda' },
      _IND(16), _BN(7),
    ] },
  ...
  { id: 'quaest-am-gov-2026-09-24', uf: 'am', creditoFotos: 'fotos: Wikimedia Commons e TSE (licenças Creative Commons)', instituto: 'QUAEST', divulgacao: '24 DE SETEMBRO',
    ...
    itens: [
      ...
      { nome: 'ISAEL MUNDURUKU', partido: 'REDE', pct: 1, foto: 'tse-am-isael-munduruku' },
      _IND(13), _BN(7),
    ] },
  ...
  { id: 'realtime-ma-gov-2026-09-10', uf: 'ma', creditoFotos: 'fotos: Wikimedia Commons e TSE (licenças Creative Commons)', instituto: 'REAL TIME BIG DATA', divulgacao: '10 DE SETEMBRO',
    ...
    itens: [
      ...
      { nome: 'ORLEANS BRANDÃO', partido: 'MDB', pct: 32, foto: 'tse-ma-orleans-brandao' },
      { nome: 'FELIPE CAMARÃO', partido: 'PT', pct: 11, foto: 'felipe-camarao' },
      { nome: 'ROBERTO ROCHA', partido: 'PRTB', pct: 5, foto: 'roberto-rocha' },
      { nome: 'ANDRÉ LUIS', partido: 'MISSÃO', pct: 1, foto: 'tse-ma-andre-luis' },
      { nome: 'OUTROS', pct: 1, tipo: 'outro' },
      _IND(3), _BN(2),
    ] },
  ...
  { id: 'datafolha-pi-gov-2026-09-17', uf: 'pi', creditoFotos: 'fotos: Wikimedia Commons e TSE (licenças Creative Commons)', instituto: 'DATAFOLHA', divulgacao: '17 DE SETEMBRO',
    ...
    itens: [
      ...
      { nome: 'LUCIA SANTOS', partido: 'PSDB', pct: 1, foto: 'tse-pi-dra-lucia-santos' },
      { nome: 'PROFESSOR JURITY', partido: 'DC', pct: 1, foto: 'tse-pi-professor-jurity' },
      { nome: 'ELIZEU AGUIAR', partido: 'NOVO', pct: 1, foto: 'tse-pi-elizeu-aguiar' },
      { nome: 'PROFESSOR GISVALDO', partido: 'PSOL', pct: 1, foto: 'tse-pi-professor-gisvaldo' },
      { nome: 'SANTIAGO BELIZÁRIO', partido: 'UP', pct: 1, foto: 'tse-pi-santiago-belizario' },
      { nome: 'LOURDES MELO', partido: 'PCO', pct: 1, foto: 'tse-pi-lourdes-melo' },
      { nome: 'GERALDO CARVALHO', partido: 'PSTU', pct: 0, foto: 'tse-pi-geraldo-carvalho' },
      { nome: 'RAVENA DA INCLUSÃO', partido: 'DEMOCRATA', pct: 0, foto: 'tse-pi-ravenna-da-inclusao' },
      _IND(8), _BN(7),
    ] },
